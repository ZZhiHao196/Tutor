...
export class AudioVisualizer {
    ...
    /**
     * Completely clears all visualization data and resets to initial state
     */
    clear() {
        console.info('Clearing audio visualizer data');
        
        // Stop any ongoing animation
        this.stop();
        
        // Reset data arrays to silent state (128 is the center value for silence)
        this.dataArray.fill(128);
        this.prevDataArray.fill(128);
        ...
        console.info('Audio visualizer cleared and reset');
    }
