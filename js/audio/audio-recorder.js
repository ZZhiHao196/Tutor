...
export class AudioRecorder extends EventTarget {
    ...
    async start(onAudioData) {
        ...
        try {
            ...
            await this.audioContext.audioWorklet.addModule('js/audio/audio-processor.js');
    ...
    /**
     * Completely clears all audio data and resets the recorder to initial state
     * More thorough than stop() - completely reinitializes all audio components
     */
    clear() {
        console.info('Clearing audio recorder data and state');
        
        try {
            // Stop recording and clear state
            this.isRecording = false;
            this.isSuspended = false;
            ...
            console.info('Audio recorder cleared and reset to initial state');
        } catch (error) {
            console.error('Error during audio recorder clear:', error);
        }
    }
}